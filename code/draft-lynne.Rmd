...
m.mlr.2.cnt <- lm(cnt ~ yr + holiday + weathersit + atemp + I(atemp^2), data = bikedata)
summary(m.mlr.2.cnt)

m.mlr.2.reg <- lm(registered ~ yr + holiday + weathersit + atemp + I(atemp^2), data = bikedata)
summary(m.mlr.2.reg)

m.mlr.2.cas <- lm(casual ~ yr + holiday + weathersit + atemp + I(atemp^2), data = bikedata)
summary(m.mlr.2.cas)
```
```{r}
