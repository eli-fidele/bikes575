...
Starting from these beginning models, we perform model building and selection in an iterative manner, for the registered and casual counts separately: 
...
Proceeding as described in the former section, the
