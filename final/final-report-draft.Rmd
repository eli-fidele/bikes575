...
```{r echo=FALSE}
head(bike_day[,1+c(1,2,3,4,5,6,7)], 2)
```
...
```{r echo=FALSE}
# summary(mod.reg.2.final)$coef[,"Estimate"]
# summary(mod.cas.2.final)$coef[,"Estimate"]
```
...
However, the 2012 rental rounts are being consistent  
